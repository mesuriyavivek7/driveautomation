            ...
            {menuOptions.map((menu,index)=>(
               <ul key={index}>
                 <Tooltip delayDuration={0}>
                    <TooltipTrigger>
                        <li>
                            <Link href={menu.href} className={clsx('group h-8 w-8 flex items-center justify-center scale-[1.5] rounded-lg p-[3px] cursor-pointer',{'dark:bg-[#2f006B] bg-[#EEE0FF]':pathName===menu.href})}>
                                <menu.Component selected={pathName===menu.href}></menu.Component>
                            </Link>
                        </li>
                    </TooltipTrigger>
                    <TooltipContent 
